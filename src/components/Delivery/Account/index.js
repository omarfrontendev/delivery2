...
class Account extends Component {
  ...
  componentDidMount() {
    ...
    this.props.updateDeliveryUserInfo(
  ...
  filterOnGoingOrders = () => {
    this.props.updateDeliveryOrderHistory(
      this.props.delivery_user.data.orders.filter(
        (order) => order.is_complete === 0
      )
    );
    this.setState({
      show_orderhistory: true,
  ...
  scrollFunc = () => {
    if (
      document.documentElement.scrollTop + 50 + window.innerHeight >
  ...
  toggleDeliveryOnOffStatus = () => {
    ...
    this.props
      .toggleDeliveryGuyStatus(delivery_user.data.auth_token)
      .then(() => {
  ...
  __changeStatusAndLogoutDelivery = () => {
    ...
    this.props
      .toggleDeliveryGuyStatus(delivery_user.data.auth_token, true)
      .then(() => {
  ...
  render() {
    ...
    return (
      <React.Fragment>
        ...
        <div
          onClick={this.toggleDeliveryOnOffStatus}
            ...
            <React.Fragment>
              {this.state.delivery_status ? (
                <div className="delivery-guy-status delivery-guy-online">
                  <span>
                    {localStorage.getItem("deliveryAppYouAreOnlineBtn")}
                  </span>
                </div>
              ) : (
                <div className="delivery-guy-status delivery-guy-offline">
                  <span>
                    {localStorage.getItem("deliveryAppYouAreOfflineBtn")}
                  </span>
                </div>
              )}
            </React.Fragment>
        ...
        <div className="mb-100 pt-20">
          ...
          <div className="row gutters-tiny px-15 mt-20">
            ...
            <div
              ...
              onClick={() => this.filterOnGoingOrders()}
            >
              <div
            ...
            <div
              className="col-6 col-xl-3"
              onClick={() => this.filterCompletedOrders()}
            >
              <div
