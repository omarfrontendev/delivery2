...
class Login extends Component {
  ...
  handleInputDriver = (event) => {
    this.setState({ driver_id: event.target.value.trim() });
  };
  ...
  handleLogin = (event) => {
    ...
    this.props.loginDeliveryUser(this.state.driver_id, this.state.password);
  };
      ...
      <React.Fragment>
        ...
        {this.state.error && (
          <div className="auth-error">
            <div className="error-shake">
              {localStorage.getItem("driverPassDonotMatch")}
            </div>
          </div>
        )}
        ...
        <div className="mt-50 mb-50">
          ...
          <div className="delivery-login-texts px-15 mt-50 pb-10 text-center">
            <span className="delivery-login-title">
              {localStorage.getItem("loginLoginTitle")}
            </span>
            <br />
            <span className="delivery-login-subtitle">
            ...
            <form onSubmit={this.handleLogin}>
              <div className="form-group px-15 pt-30">
                <label className="col-12 edit-address-input-label">
                  {localStorage.getItem("loginLoginDriverLabel")}
                </label>
                <div className="col-md-9 pb-5">
                  <input
                    type="text"
                    name="driver_id"
                    onChange={this.handleInputDriver}
