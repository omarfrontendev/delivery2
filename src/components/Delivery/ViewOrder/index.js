...
class ViewOrder extends Component {
	...
	__getDirectionToRestaurant = (restaurant_latitude, restaurant_longitude) => {
		const directionUrl = "https://maps.google.com/maps?q=" + restaurant_latitude + "," + restaurant_longitude;
		window.open(directionUrl, '_self');
	};
	__getDirectionToUser = (order) => {
		try {
															...
															<div className="list-timeline-content">
																...
																<div>
																	<button
																		...
																		onClick={() =>
																			this.__getDirectionToUser(order)
																		}
																	>
																		<i className="si si-action-redo mr-5" />
																		{localStorage.getItem(
